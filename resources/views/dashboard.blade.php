                                        ...
                                        <a href="activitiesjavascript:void(0);">
                                            <div class="media d-flex">
                                                ...
                                                <div class="media-body flex-grow-1">
                                                    <p class="noti-details"><span class="noti-title">Glam
                                                            Studio</span>
                                                        added a new <span class="noti-title">Bridal Makeup
                                                            Package</span>
                                                    </p>
                                                    <p class="noti-time"><span class="notification-time">5 mins
                                                            ago</span>
                                                    </p>
                                                </div>
                                            </div>
                                    ...
                                    <li class="notification-message">
                                        <a href="activitiesjavascript:void(0);">
                                            <div class="media d-flex">
                                                ...
                                                <div class="media-body flex-grow-1">
                                                    <p class="noti-details"><span class="noti-title">Sarah
                                                            Johnson</span>
                                        ...
                                        <a href="activitiesjavascript:void(0);">
                                            <div class="media d-flex">
                                                ...
                                                <div class="media-body flex-grow-1">
                                                    ...
                                                    <p class="noti-time"><span class="notification-time">25 mins
                                                            ago</span>
                                                    </p>
                                                </div>
                                            </div>
                                    ...
                                    <li class="notification-message">
                                        <a href="activitiesjavascript:void(0);">
                                            <div class="media d-flex">
                                                ...
                                                <div class="media-body flex-grow-1">
                                                    <p class="noti-details"><span class="noti-title">Olivia
                                                            Martin</span>
                                                        left a 5-star review on <span class="noti-title">Nail Art
                                                            Service</span>
                                                    </p>
                                                    <p class="noti-time"><span class="notification-time">1 hour
                                                            ago</span>
                                                    </p>
                                                </div>
                                            </div>
                    ...
                    <div class="col-md-4 ">
                        <div class="stat-card">
                            <div class="stat-icon warning">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                    stroke-linecap="round" stroke-linejoin="round" data-lucide="bar-chart-3"
                                                ...
                                                <div class="d-flex align-items-center ActionDropdown">
                                                    <div class="d-flex">
                                                        ...
                                                        <a class="btn btn-icon btn-flush-dark btn-rounded flush-soft-hover"
                                                            ...
                                                            title="" data-bs-original-title="Salon Details"
                                                            href="salon-details.php">
                                            ...
                                            <td>
                                                <a href="salon-details.php">
                                                    <div class="tbUserWrap">
                                                        ...
                                                        <div class="media-body">
                                                            <span class="d-block text-high-em">Elite Beauty
                                                                Lounge</span>
                                            ...
                                            <td>
                                                <a href="salon-details.php">
                                                    <div class="tbUserWrap">
                                                        ...
                                                        <div class="media-body">
                                                            <span class="d-block text-high-em">Harmony Spa &
                                                                Salon</span>
                                            ...
                                            <td>
                                                <a href="salon-details.php">
                                                    <div class="tbUserWrap">
                                                        ...
                                                        <div class="media-body">
                                                            <span class="d-block text-high-em">Royal Crown
                                                                Beauty</span>
