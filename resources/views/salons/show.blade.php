<x-app-layout>
    ...
    <link rel="stylesheet" href="{{ asset('assets/css/salon-details.css') }}">
        ...
        <div class="content">
            <div
                ...
                <div class="d-flex my-xl-auto right-content align-items-center flex-wrap ">
                    <div class="">
                        <button type="button" class="salon-detail-action-btn salon-detail-btn-danger me-2"
                            id="suspendAccountBtn">
                            <iconify-icon icon="material-symbols:block"></iconify-icon>Suspend Account
                        </button>
                    </div>
                    <div class="">
                        <button type="button" class="salon-detail-action-btn salon-detail-btn-primary"
                            id="sendReminderBtn">
    ...
    <div class="modal fade" id="suspendConfirmModal" tabindex="-1" aria-labelledby="suspendConfirmModalLabel"
        aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="salon-detail-form-control form-control" rows="3" placeholder="Add a personal message..."></textarea>
                    </div>
                </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            confirmSuspendBtn.addEventListener('click', function() {
                // Show loading state
                confirmSuspendBtn.innerHTML =
                    '<iconify-icon icon="eos-icons:loading"></iconify-icon>Suspending...';
            ...
            confirmSendReminderBtn.addEventListener('click', function() {
                ...
                const customMessage = document.querySelector(
                    '#sendReminderModal .salon-detail-form-control').value;
                ...
                // Show loading state
                confirmSendReminderBtn.innerHTML =
                    '<iconify-icon icon="eos-icons:loading"></iconify-icon>Sending...';
                ...
                setTimeout(() => {
                    ...
                    confirmSendReminderBtn.innerHTML =
                        '<iconify-icon icon="material-symbols:send"></iconify-icon>Send Reminder';
            ...
            function updateSalonStatus(status) {
                ...
                if (status === 'suspended') {
                    suspendAccountBtn.innerHTML =
                        '<iconify-icon icon="material-symbols:play-arrow"></iconify-icon>Reactivate Account';
