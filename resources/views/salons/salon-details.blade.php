                    ...
                    <div class="card-body">
                        <div class="salon-detail-profile">
                            <div class="salon-detail-avatar">
                                <img src="{{asset('assets/img/users/userdummy.png')}}" alt="Glamour Studio" class="salon-detail-image">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <button class="btninvoiceDownload btn">
                                                        <iconify-icon icon="bytesize:download"></iconify-icon> Download
                                                    </button>
                                                </td>
                                            </tr>
                                            <tr>
                                ...
                                <div class="salon-detail-artists-grid card-body">
                                    <div class="salon-detail-artist-card">
                                        <div class="salon-detail-artist-avatar">
                                            <img src="{{asset('assets/img/users/userdummy.png')}}" alt="Emma Wilson">
                                        </div>
                                    ...
                                    <div class="salon-detail-artist-card">
                                        <div class="salon-detail-artist-avatar">
                                            <img src="{{asset('assets/img/users/userdummy.png')}}" alt="Michael Chen">
                                        </div>
                                        <div class="salon-detail-artist-info">
                                    ...
                                    <div class="salon-detail-artist-card">
                                        <div class="salon-detail-artist-avatar">
                                            <img src="{{asset('assets/img/users/userdummy.png')}}" alt="Sofia Rodriguez">
                                        </div>
                                        <div class="salon-detail-artist-info">
                                    ...
                                    <div class="salon-detail-artist-card">
                                        <div class="salon-detail-artist-avatar">
                                            <img src="{{asset('assets/img/users/userdummy.png')}}" alt="James Thompson">
                                        </div>
                                        <div class="salon-detail-artist-info">
