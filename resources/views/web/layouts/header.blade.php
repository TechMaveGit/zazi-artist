...
<head>
    ...
    <!-- icofont-css-link -->
    <link rel="stylesheet" href="{{ asset('web_assets/css/icofont.min.css') }}">
    ...
    <link rel="stylesheet" href="{{ asset('web_assets/css/checkout.css') }}">
    <link rel="stylesheet" href="{{ asset('web_assets/css/profile.css') }}">
    <!-- Favicon -->
    <!-- Favicon -->
    <link rel="shortcut icon" href="{{ asset('web_assets/images/new-image/beautyPro.png') }}" type="image/x-icon">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item">
                            <div class="btn_block">
                                @auth('salon')
                                    <a class="nav-link dark_btn" href="{{ route('web.profile') }}">Profile</a>
                                @else
                                    <a class="nav-link dark_btn" href="{{ route('web.login') }}">Login Now</a>
                                @endauth
