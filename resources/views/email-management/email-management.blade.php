                        ...
                        <div class="metric-content">
                            ...
                            <div class="metric-icon primary">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                    ...
                                    stroke-linejoin="round" data-lucide="file-text" class="lucide lucide-file-text">
                    ...
                    <div class="metric-card">
                        <div class="metric-content">
                            ...
                            <div class="metric-icon warning">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                    fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                    stroke-linejoin="round" data-lucide="edit-3" class="lucide lucide-edit-3">
                    ...
                    <div class="metric-card">
                        <div class="metric-content">
                            ...
                            <div class="metric-icon primary">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                    fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                    stroke-linejoin="round" data-lucide="star" class="lucide lucide-star">
                                    <polygon
                            ...
                            <div class="d-flex align-items-center ActionDropdown">
                                <div class="d-flex">
                                    ...
                                    <a class="btn btn-icon btn-flush-dark btn-rounded flush-soft-hover"
                                        ...
                                        data-bs-original-title="Edit Template" href="{{route('email.edit')}}">
