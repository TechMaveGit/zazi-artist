                                ...
                                <div class="card-body">
                                    ...
                                    <div class="email-template-setting-item">
                                        <div class="email-template-setting-info">
                                            ...
                                            <p class="email-template-setting-description">Available for sending to
                                                customers</p>
                                        </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="email-template-content-source mb-4">
                                        ...
                                        <div class="email-template-source-tabs">
                                            <button type="button" class="email-template-source-tab active"
                                                data-source="editor">
                                                <iconify-icon icon="material-symbols:edit-outline"></iconify-icon>
                                                Text Editor
                                            </button>
                                            <button type="button" class="email-template-source-tab"
                                                data-source="upload">
                                                <iconify-icon
                                                    icon="material-symbols:upload-file-outline"></iconify-icon>
                                                Upload Word File
                                            </button>
                                        </div>
                                    </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="email-template-file-upload" id="fileUploadArea">
                                                ...
                                                <div class="email-template-upload-content">
                                                    <iconify-icon icon="material-symbols:upload-file-outline">
                                                    </iconify-icon>
                                                    <p>Drag and drop your Word document here or <span
                                                            class="email-template-upload-link">browse files</span></p>
                                                    <small class="email-template-upload-note">Supports .doc and .docx
                                                        files</small>
                                                </div>
                                            </div>
                                            <div class="email-template-file-info" id="fileInfo"
                                                style="display: none;">
                                                <div class="email-template-file-details">
                                                    <iconify-icon icon="material-symbols:description-outline">
                                                    </iconify-icon>
                                                    ...
                                                    <button type="button" class="email-template-file-remove"
                                                        id="removeFile">
                                ...
                                <div class="card-footer">
                                    <div class="email-template-preview-info">
                                        ...
                                        <div class="email-template-info-item">
                                            ...
                                            <span class="email-template-badge email-template-badge-success"
                                                id="previewStatus">Active</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    @push('scripts')
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                ...
                const emailEditor = document.getElementById('summernote');
                ...
                function handleFileUpload(file) {
                    ...
                    // Show a loading indicator (optional, assuming you have an element with id 'loading')
                        ...
                        if (file.name.toLowerCase().endsWith('.docx') || file.name.toLowerCase().endsWith('.doc')) {
                            mammoth.convertToHtml({
                                ...
                                .catch(function(error) {
                                    ...
                                    alert('Error processing the document. Please try a different file.');
                                    showSampleContent();
                                });
                        } else {
                            alert(
                                ' .doc files are not fully supported client-side. Please upload a .docx file for preview.'
                            );
                            showSampleContent();
                        }
                    };
                ...
                function showSampleContent() {
                    const sampleContent = `
                        ...
                        <p>Dear [name],</p>
                        <p>We're thrilled to welcome you to the BeautyPro platform! Your journey to streamlined salon management starts
                            here.</p>
                        <h3>What's Next?</h3>
                        <ul>
                        ...
                        <p>If you have any questions, our support team is here to help at <a
                                href="mailto:support@beautypro.com">support@beautypro.com</a></p>
                ...
                function saveTemplate() {
                    ...
                    setTimeout(() => {
                        ...
                        saveTemplateBtn.innerHTML =
                            '<iconify-icon icon="prime:check-circle"></iconify-icon>Saved!';
